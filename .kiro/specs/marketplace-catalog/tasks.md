...
- [ ] 3. Create validation schemas and types
...
- [ ] 4. Build core search and filter services
...
- [ ] 5. Create catalog page with server-side rendering
...
- [ ] 6. Implement filter sidebar and mobile drawer
...
- [ ] 7. Build filter pills and state management
...
- [ ] 8. Create product detail pages with SSG
...
- [ ] 9. Implement search redirect and URL handling
